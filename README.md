# 🎨 Shadcn/UI InputOTP for Weweb

Beautiful **InputOTP component** from [shadcn/ui](https://ui.shadcn.com/) adapted for Weweb.

## 🚀 Import in Weweb

1. Copy this repository URL: `https://github.com/YOUR_USERNAME/shadcn-inputotp`
2. In Weweb editor, open developer panel (F12)
3. Add as "custom element"
4. The InputOTP component will appear in your elements!
